...
export const prospectSearchApi = {
  ...
  async enrichPlaceResult(place: PlaceResult, targetTitles?: string[]): Promise<ProspectResult | null> {
    ...
    const enriched = data.data as Record<string, any> | null | undefined;
    const e = enriched || {};
    return {
      full_name: String(e.full_name || place.owner_mentions[0] || '') || null,
      email: String(e.email || '') || null,
      phone: String(e.phone || place.phone || '') || null,
      mobile_phone: String(e.mobile_phone || '') || null,
      direct_phone: String(e.direct_phone || '') || null,
      job_title: String(e.job_title || (place.owner_mentions[0] ? 'Owner' : '') || '') || null,
      seniority_level: String(e.seniority_level || 'owner'),
      department: String(e.department || 'executive'),
      linkedin_url: String(e.linkedin_url || '') || null,
      company_name: String(e.company_name || place.name || ''),
      company_domain: domain,
      company_website: place.website,
      company_linkedin_url: String(e.company_linkedin_url || '') || null,
      industry: String(e.industry || place.types[0]?.replace(/_/g, ' ') || '') || null,
      employee_count: e.employee_count != null ? Number(e.employee_count) : null,
      annual_revenue: e.annual_revenue != null ? Number(e.annual_revenue) : null,
      founded_year: e.founded_year != null ? Number(e.founded_year) : null,
      headquarters_city: String(e.headquarters_city || '') || null,
      headquarters_state: String(e.headquarters_state || '') || null,
